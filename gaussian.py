...
def solve_sdp(Sigma, tol=1e-3):
    ...
    print('Converted covariance matrix to a correlation matrix.')
    ...
    print('Solving optimization problem using CVXOPT solver...')
...
class GaussianKnockoffs:
    ...
    def __init__(self, Sigma, method="equi", mu=[], tol=1e-3):
        ...
        :return:
        """
        print('Initializing Gaussian Knockoffs...')
        if len(mu)==0:
